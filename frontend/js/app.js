...
App.renderShell = function () {
    ...
    const navItems = [
        ...
        { type: 'label', label: 'MAINTENANCE', roles: ['admin', 'manager'] },
        { label: '🔧 Schedules', route: '/maintenance', roles: ['admin', 'manager'] },
        { label: '📅 New Schedule', route: '/maintenance/new', roles: ['admin', 'manager'] },
...
App.router.register('/maintenance', 'maintenance-list');
App.router.register('/maintenance/new', 'maintenance-form');
